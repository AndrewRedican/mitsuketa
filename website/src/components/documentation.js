...
class Documentation extends Component {
    ...
    sections(){
        ...
        const list = functionNames.map( (fxName,i) => {
            return(
                <div 
                    ...
                    <h2 className = 'w3-wide'>{fxName.toUpperCase()}</h2>
                    <p className = 'w3-opacity'><i>{fxName + '(' + getParamNames(Mitsuketa[fxName]).join(',') + ')'}</i></p>
                    <div className = 'w3-panel w3-border-left w3-theme-l5'>
                        <p className = 'w3-justify'>{Info[fxName].description}</p>
                    </div>
                    <table style = {{ width : '100%' }}>
                        <tbody>
                            <tr><td className = 'w3-left-align w3-opacity'><b>Arguments:</b></td></tr>
                            ...
                            <tr><td className = 'w3-left-align w3-opacity'><b>Returns:</b></td></tr>
                            <tr><td className = 'w3-left-align w3-text-theme'>
                                    <b><i>
                                    <p className = 'w3-left-align w3-small' style = {{ paddingLeft : '15px', marginTop : '5px' }} >
        ...
        return (
            <div name = 'sections' id = 'sections'  style = {{ position  : 'relative', overflowY : 'scroll' }}>
                {list}
            </div>
        );
    }
